...
function getCustomer($customerParams){
   ...
   if(empty(trim($customerParams['id']))){
   ...
   if($result){
    ...
    }else
    {
        ...
        $data=[
            'status'=>404,
            'message'=>'No Custommer Found'
        ];
        header('HTTP/1.0 404 No Custommer Found');
        return json_encode( $data);
...
function updateCustomer($customerInput,$customerParams){
    ...
    }elseif(empty($customerParams['id'])){
        return error422('Enter your customer id');
    }
...
function deleteCustomer($customerParams){
    ...
    //  echo  $result;
     ...
     if($result){
        ...
        header('HTTP/1.0 404 Not successfully');
        return json_encode( $data);
